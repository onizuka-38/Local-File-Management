...
- 인덱싱: `SQLite + FTS5`
- 검색 API: `FastAPI` (+ 기본 운영 메트릭 엔드포인트)
- 웹 UI: `Streamlit`
...
- `LFM_WEB_TIMEOUT_SEC` (기본값: `10`)
- `LFM_WEB_MAX_RETRIES` (기본값: `2`)
- `LFM_WEB_ALLOWED_DOMAINS` (기본값: 비어있음, 예: `example.com,docs.python.org`)
